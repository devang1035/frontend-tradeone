...
function Hero() {
  return (
    <div className="container ">
      ...
      <div className="row p-5 mt-5 border-top text-muted fs-7">
        ...
        <div className="col-6 p-5">
          <p>
            ...
            <p>
           <span style={{color:"royalblue"}}>Rainmatter</span> , our fintech fund and incubator, has invested in several
